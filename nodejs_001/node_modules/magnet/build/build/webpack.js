 ...
 * @return {Object}
 */
function getDefaultWebpackConfig(magnet) {
  return {
    output: {
      path: _path2.default.join(magnet.getDirectory(), '.magnet'),
      filename: '[name]'
    },
    ...
    resolve: {
      extensions: ['.js', '.json'],
      modules: [_path2.default.join(magnet.getDirectory(), 'node_modules'), _path2.default.join(__dirname, '../../node_modules'), 'node_modules']
    },
    resolveLoader: {
      modules: [_path2.default.join(magnet.getDirectory(), 'node_modules'), _path2.default.join(__dirname, '../../node_modules'), 'node_modules']
    },
